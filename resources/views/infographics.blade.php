        ...
        <div class="section__container">
            ...
            <div class="infographic">
                <table>
                    ...
                    <tbody>
                        @foreach ($infographics as $publication)
                            <tr>
                                <td><a href="#">{{ $publication['title'] }}</a></td>
                                <td>{{ \Carbon\Carbon::parse($publication['created_at'])->format('jS F Y') }}</td>
                                <!-- <td>{{ $publication['created_at'] }}</td> -->
                                <td>{{ substr($publication['description'], 0, 100) }}...</td>
                            </tr>
            ...
            <div class="pagination">
                ...
                <a class='page-numbers' href='/infographics/page/2/'>2</a>
                <a class="next page-numbers" href="/infographics/page/2/"><i class="fa fa-caret-right"></i></a>
            </div>
        </div>
    </section>
